...
def word2vec_basic(log_dir):
    ...
    filename = "C:\Users\akker\Desktop\SR-GNN-master\datasets\sample_train-item-views.csv"

    # Read the data into a list of strings.
vocabulary = ["akker","corgi","reyho","aytugu","ayutu","röha","metefeakker","mtfakker","emrullah","fosix","canbulut"]
